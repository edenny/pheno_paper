...
datasets.
  * **[Triplifier](https://github.com/jdeck88/biocode-fims-fuseki)** This codebase builds a JAR file for triplifying.... download the code and build a triplifier.jar in the dist directory using ./gradlew shadowJar build task. Email author of this repo if you want a copy of the jar itself without building.
  ...
  * **[PPO](https://github.com/plantphenoontology/PPO)** The Plant Phenology Ontology repository which stores the raw and reasoned versions of the PPO
